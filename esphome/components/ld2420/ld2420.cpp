...
void LD2420Component::dump_config() {
  ...
  LOG_BUTTON(TAG, "  Apply Config:", this->apply_config_button);
  LOG_BUTTON(TAG, "  Revert Edits:", this->revert_config_button);
  LOG_BUTTON(TAG, "  Factory Reset:", this->factory_reset_button);
  LOG_BUTTON(TAG, "  Restart Module:", this->restart_module_button);
